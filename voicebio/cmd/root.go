...
var (
	modelId           string
	verifyConfigStr   string
	identifyConfigStr string
	voiceprint        string
	voiceprintlist    []string
...
var rootCmd = &cobra.Command{
	Use:   "voicebio-client",
	Short: "voicebio is a command line interface for interacting with a running instance of voicebio-server.",
	Long:  `voicebio is a command line interface for interacting with a running instance of voicebio-server.`,
}
...
func init() {
	...
	rootCmd.AddCommand(buildVoicebioEnrollCmd())
	rootCmd.AddCommand(buildVoicebioVerifyCmd())
	rootCmd.AddCommand(buildVoicebioIdentifyCmd())
